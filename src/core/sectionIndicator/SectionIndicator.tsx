...
const SectionIndicator: FC<sectionIndicatorProps> = ({ current }) => {
  ...
  return (
    <div id="section-indicator" className="absolute bottom-22 right-0">
      <div
      ...
      >
        ...
        <div className="rotate-90 origin-center text-[12px] font-mono tracking-[.25rem] uppercase whitespace-nowrap max-w-12">
          {current}
        </div>
      </div>
    </div>
